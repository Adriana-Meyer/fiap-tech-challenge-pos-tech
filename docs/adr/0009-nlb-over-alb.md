...
- Não é necessário instalar o AWS Load Balancer Controller no [Repositório 2](https://github.com/Adriana-Meyer/fiap-tech-challenge-kubernetes-infrastructure).
