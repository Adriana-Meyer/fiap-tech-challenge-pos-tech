...
- **CPF sozinho, sem senha** (mais fiel ao fluxo de exemplo do enunciado, "cliente informa o CPF"): rejeitada por reduzir a segurança de rotas que hoje protegem operações sensíveis (estoque, preços, ordens de serviço) — CPF não é secreto.
