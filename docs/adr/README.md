...
| [0005](0005-terraform-kind-ci-validation.md) | Terraform + kind para simular deploy em CI sem custo de nuvem |
...
| [0010](0010-additive-deploy-paths.md) | Dois caminhos de deploy no Repositório 4, aditivos |
